...
四个prismatic被动悬挂，每轮±50 mm机械行程。2026-09-15依据用户提供的暂定响应目标，刚度改为8000 N/m；初始阻尼750 N·s/m，横移回摆对照后现行阻尼1200 N·s/m。前后轴分别设置弹簧参考位置以维持550 kg负重车高。现行持续加速/制动俯仰实测约1.19°/1.44°，具体参数、验证边界及回退见[悬挂调参](SUSPENSION_TUNING.md)。这是等效线性悬挂响应拟合，不声称已匹配真实弹簧、减振器或连杆机构。
