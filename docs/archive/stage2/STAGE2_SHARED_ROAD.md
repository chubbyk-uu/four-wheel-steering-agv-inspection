...
![10×10 m 材质布局](../../images/shared_road_layout.png)
...
![Gazebo 实际材质与双黄线](../../images/shared_road_gz.png)

## 相机样片与坐标检查

下图由实际 4096² 原图作面积缩小显示，保持原始 DN，不拉伸对比度。左为裂缝段，右为跨横缝段。标线的灰度不是 GZ 黄色丢失，而是单色相机响应。

![实际线阵相机采集](../../images/shared_road_camera.png)

原分辨率裂缝局部：

![裂缝原生像素裁剪](../../images/shared_road_crack_crop.png)
