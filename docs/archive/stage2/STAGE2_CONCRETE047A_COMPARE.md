...
[两版对比](../../images/concrete_material_comparison.png)；[Concrete047A全景和前后局部](../../images/concrete047a_comparison.png)；[Gravel全景和前后局部](../../images/gravel_concrete_comparison.png)。结果报告：results/stage2_concrete047a_bake.json及results/stage2_gravel_bake.json。
