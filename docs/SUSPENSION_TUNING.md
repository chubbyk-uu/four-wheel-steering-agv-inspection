...
已实际查看六张原图缩略对照，路面标识、裂缝和尾图比例正常；刹车附近有可见的明暗条带，尚未独立分解姿态、光斑与曝光贡献，**不将消息/文件一致解释为刹车段画质已验收**。GUI/RViz本轮为自动窗口与TF检查，未重做鼠标操作或运动部件的屏幕人工验收。未启用在线校正。原图预览保留在`local_data/suspension_tuning/raw_preview.png`。
